...
export default function RoleTable({ data, onDelete, onEdit, onDetail }: { data: Role[], onDelete: (id: number) => void, onEdit: (isEdit: boolean, data: any) => void, onDetail: (id: number) => void }) {
	// console.log(data);
  return (
